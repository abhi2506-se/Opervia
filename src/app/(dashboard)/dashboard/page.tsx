  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-4 gap-4 mb-6">
        ...
        <StatCard label="Proposals accepted" value={proposalsAccepted} />
        <StatCard label="Pending follow-ups" value={pendingTasks} />
        <StatCard label="Overdue follow-ups" value={overdueTasks} />
        <StatCard label="Pending commission" value={`₹${(pendingCommissionAgg._sum.amount ?? 0).toLocaleString()}`} />
        <StatCard label="Paid commission" value={`₹${(paidCommissionAgg._sum.amount ?? 0).toLocaleString()}`} />
      </div>
